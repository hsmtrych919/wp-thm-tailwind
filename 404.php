...
<div class="headline__outer">
    <div class="container-width mx-auto flex flex-wrap justify-center px-gutter-row xl:px-0">
      <div class="headline__content" >
        ...
        <p class="headline__lead">404 not found</p>
      </div>
    </div>
  </div>
  ...
  <div class="container-width mx-auto flex flex-wrap justify-center px-gutter-row xl:px-0 mt-8 ">
