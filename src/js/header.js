...
export function navMenuMobile() {
  ...
  nodeHeader.insertAdjacentHTML('beforeend', '<div class="c-nav__overlay p-nav__overlay" id="grobal__nav--overlay"></div>');

  const nodeNav = document.querySelector('#grobal__nav');
  const nodeToolbar = document.querySelector('#grobal__nav--toolbar');
  const nodeToolbarLine = document.querySelector('button .c-toolbar__line');
  const nodeBtn = document.querySelectorAll('#grobal__nav a[class^="c-nav__"]');
