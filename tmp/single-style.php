...
<div class="headline__outer">
    <div class="container-width mx-auto flex flex-wrap justify-start px-gutter-row xl:px-0">
      <div class="headline__frame" >
        <h1 class="headline__title"><span class="">STYLE</span></h1>
        <div class="headline__detail">
    <p class="">
    <span class="ttl__xsmall text-clr3"><span class="text-clr1">#</span> <?php the_title(); ?></span></p>
        </div>
  ...
  <div class="style__content">
    <div class="container-width mx-auto flex flex-wrap justify-start px-gutter-row xl:px-0">
      <div class="style__frame">

      <div class="style__pic">
...
<?php else : ?>
    <div class="style-pic__box">
      <p class="style-pic__single"><?php echo $thumbnail01 ?></p>
    </div>
<?php endif; ?>
      </div>
      ...
      <div class="style__detail">

    <p class="style__category--title">カテゴリー：</p>

<?php
  $terms = get_the_terms($post->ID, 'style_category');
  if($terms):
    echo '<ul class="style__category--list">';
    foreach($terms as $term):
      $term_name = $term->name;
      $term_link = get_term_link( $term );
      echo '<li><a href="'.$term_link.'" class="style__category--button">';
      echo $term_name;
      echo '<svg class="style__category--button-icon" data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5"></path></svg>';
      echo '</a></li>';
    endforeach;
    echo '</ul>';
  endif;
?>
        <p class="style__comment"><?php the_field( 'style_comment' ); ?></p>
