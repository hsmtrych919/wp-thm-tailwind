...
<article class="">
  <div class="headline-pic__outer">
    <div class="container-width mx-auto flex flex-wrap justify-start px-gutter-row xl:px-0">
      <div class="headline-pic__frame js-headline-frame" >
        <h1 class="headline-pic__title headline-pic__title--long"><span class="headline-pic__typ--for-gsap">CAMPAIGN</span></h1>
        ...
        <div class="headline-pic__detail headline-pic__typ--for-gsap">
          <p class="typ">セットメニューがとってもお得なキャンペーン実施中！</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <section class=" mt-6">
      <div class="container-width mx-auto flex flex-wrap justify-between px-gutter-row xl:px-0">
        <div class="campaign__content">

        <div class="flex flex-wrap justify-center">
          <div class="w-full">
            <p class=""><span class="ttl__small text-clr3"><span class="text-clr1">#</span> スペシャルチョイスメニュー</span></p>
          </div>
        </div>
        ...
        <ul class="campaign__list">
            <li>
              ...
              <p class="campaign__period"><?php echo $period?></p>
                  <div class="campaign__title">
                    <span class="campaign__title--caption">初めて or 1年以上ぶりのお客様限定</span>
                  カット＋スペシャルチョイスメニュー（お好きなものいくつでもOK）</div>
                  <div class="campaign__detail">
                    <p>セットメニューにするととってもお得！小顔効果と再現性の高い技術でお客様の「なりたい想い」を叶えます。</p>
                  </div>
                  <p class="campaign__price--normal">【通常価格¥4,730＋追加メニュー価格】</p>
                  <p class="campaign__price--frame">
                  <span class="campaign__price--caption">キャンペーン価格</span>
                    <br class="lg:hidden">
                    <span class="campaign__price">¥3,311 ＋ <br class="sm:hidden">追加メニュー30%OFF価格</span>
                  </p>
        ...
        <div class="flex flex-wrap justify-center mt-5">
          <div class="w-full">
            <p class=""><span class="ttl__small text-clr3"><span class="text-clr1">#</span> 至高シリーズ</span></p>
          </div>
        </div>
        <div class="flex flex-wrap justify-start mt-2">
        <ul class="campaign__list">
...
?>
        ...
        <div class="campaign__content--reserve">
          <div class="campaign__reserve">
            <p class="typ text-gray-700">ご予約はこちら</p>
            <ul class="campaign__reserve--list">
<?php
