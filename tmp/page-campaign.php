...
$notice_all = '<p class="fz__14 clr__gray mt__1">※価格は全て税込表示です。<br>※カラー・パーマ・トリートメントはセミロング各+¥550 ロング各+¥1,100<br>※他の割引・特典との併用不可</p>';
?>
...
<article class="">
    ...
    <div class="l-row--container c-gutter__row jc__start">
      <div class="c-headline-pic__frame js-headline-frame" >
        ...
        <div class="c-headline-pic__detail c-headline-pic__typ--for-gsap">
          <p class="c-typ">セットメニューがとってもお得なキャンペーン実施中！</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <section class=" mt__6">
      <div class="l-row--container c-gutter__row jc__between">
        <div class="p-campaign__content">

        <div class="l-row">
          <div class="c-col--12">
            <p class=""><span class="c-ttl__small clr__3"><span class="clr__1">#</span> スペシャルチョイスメニュー</span></p>
          </div>
        </div>
            ...
            <li>
              ...
              <p class="p-campaign__period"><?php echo $period?></p>
                  ...
                  <span class="p-campaign__price--caption">キャンペーン価格</span>
                    <br class="hide__lg--up">
                    <span class="p-campaign__price">¥3,311 ＋ <br class="hide__sm--up">追加メニュー30%OFF価格</span>
                  </p>
                  <p class="fz__14 clr__gray mt__1">例）カット＋グレイカラーの場合、通常価格10,010円が7,007円。<br>カット＋縮毛矯正の場合、通常価格22,550円が15,785円。</p>
                  <?php echo wp_kses_post($notice_all)?>
              </div>
          </li>
          </ul>
            </div>
        <div class="l-row mt__5">
          <div class="c-col--12">
            <p class=""><span class="c-ttl__small clr__3"><span class="clr__1">#</span> 至高シリーズ</span></p>
          </div>
        </div>
        <div class="l-row jc__start mt__2">
        <ul class="p-campaign__list">
...
?>
        ...
        <div class="p-campaign__content--reserve">
          <div class="p-campaign__reserve">
            <p class="c-typ clr__gray">ご予約はこちら</p>
