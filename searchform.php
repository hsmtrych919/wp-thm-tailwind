<div class="c-search">
  <form role="search" method="get" class="c-search__form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
      <input type="search" class="c-search__control" placeholder="<?php echo esc_attr_x( '検索キーワードを入力', 'placeholder' ) ?>" value="<?php echo esc_attr( get_search_query() ); ?>" name="s" title="<?php echo esc_attr_x( 'Search for:', 'label' ); ?>">
