...
<article class="container-py--search">
  <div class="ttl__search px-gutter-row xl:px-0">
    <p class="ttl__search--caption">検索キーワード</p>
    <h1 class="ttl__search"><span><?php the_search_query(); ?></span></h1>
  </div>
