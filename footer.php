...
<?php if ( $isContactPage ): ?>
  <footer class="l-footer  p-footer">
    <div class="l-container mx-auto flex flex-wrap justify-center px-gutter-row xl:px-0 md:justify-between">
      <div class="p-footer__info p-footer__info--alone">
      <?php echo $logo_element . $message_element . $copy_element; ?>
      </div>
    </div>
  </footer>
<?php else : ?>
  <footer class="l-footer  p-footer p-footer--have-footernavi">
    <div class="l-container mx-auto flex flex-wrap justify-center px-gutter-row xl:px-0 md:justify-between">
      ...
      <?php foreach ($footer_links as $url => $label) : ?>
          <li class="p-footer__links--item"><a href='<?php echo home_url('/'.$url); ?>'><?php echo $label; ?></a></li>
      <?php endforeach; ?>
        </ul>
    </div>
  </footer>
...
<p id="js-fadeButton-pagetop" class="p-footer__fade--button">
  <a href="#top" class="p-footer__fade-link">
  <svg class="p-footer__fade-icon" data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
<!-- instagram -->
  <li class="p-footernav__item<?php echo esc_attr($prefixFooternavItem); ?>">
      <a class="p-footernav__button gtm-footer-insta" href="https://www.instagram.com/guiches_official/?hl=ja" target="_blank" rel="noopener noreferrer">
...
<?php if ( !$isRecruitPage ) : ?>
    <!-- recruit -->
    <li class="p-footernav__item<?php echo esc_attr($prefixFooternavItem); ?>">
        <a class="p-footernav__button gtm-footer-recruit" href='<?php echo home_url('/recruit');?>' >
      <span>採用情報</span>
...
<?php endif; ?>
  ...
  <?php else : ?>
    <!-- salon -->
    <li class="p-footernav__item<?php echo esc_attr($prefixFooternavItem); ?>"><a class="p-footernav__button  gtm-footer-salon" href='<?php echo home_url('/salon');?>' >
    <span>サロン一覧</span>
    <?php echo $icon_salon; ?>
    </a></li>
      ...
      <?php if ( !$isRecruitPage ) : ?>
        <!-- reserve -->
        <li class="p-footernav__item--reserve"><button data-micromodal-trigger="modal-salonlist" role="button" class="p-footernav__button--reserve gtm-footer-reserve-list"  >
          <div class="p-footernav__button--reserve-inner">
...
function listItemSalon($salonKey, $icon_reserve) {
  ...
  $tel = $data['tel_href'];
      ...
      echo '<a class="sm:hidden p-footernav__button ' . $class_name_reserve . '" href="' . esc_url($url) . '" target="_blank" rel="noopener noreferrer">';
      echo '<span>予約する</span>';
      echo '<svg class="p-footernav__button-icon" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path clip-rule="evenodd" fill-rule="evenodd" d="M6.75 2.25A.75.75 0 017.5 3v1.5h9V3A.75.75 0 0118 3v1.5h.75a3 3 0 013 3v11.25a3 3 0 01-3 3H5.25a3 3 0 01-3-3V7.5a3 3 0 013-3H6V3a.75.75 0 01.75-.75zm13.5 9a1.5 1.5 0 00-1.5-1.5H5.25a1.5 1.5 0 00-1.5 1.5v7.5a1.5 1.5 0 001.5 1.5h13.5a1.5 1.5 0 001.5-1.5v-7.5z"></path></svg>';
      echo '</a>';
      echo '<a class="hidden sm:block p-footernav__button--reserve ' . $class_name_reserve . '" href="' . esc_url($url) . '" target="_blank" rel="noopener noreferrer">';
      echo '<div class="p-footernav__button--reserve-inner">';
      echo $icon_reserve;
      echo '<span>予約する</span>';
      echo '</div>';
      echo '</a>';
      ...
      echo '<a class="p-footernav__button--tel ' . $class_name_tel . '" href="tel:' . esc_attr($tel) . '">';
      echo '<div class="p-footernav__button--tel-inner">';
      echo '<svg class="p-footernav__button--tel-icon" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path clip-rule="evenodd" fill-rule="evenodd" d="M1.5 4.5a3 3 0 013-3h1.372c.860 0 1.61.586 1.819 1.42l1.105 4.423a1.875 1.875 0 01-.694 1.955l-1.293.97c-.135.101-.164.249-.126.352a11.285 11.285 0 006.697 6.697c.103.038.25.009.352-.126l.97-1.293a1.875 1.875 0 011.955-.694l4.423 1.105c.834.209 1.42.959 1.42 1.82V19.5a3 3 0 01-3 3h-2.25C8.552 22.5 1.5 15.448 1.5 6.75V4.5z"></path></svg>';
      echo '<span>電話する</span>';
      echo '</div>';
      echo '</a>';
      echo '</li>';
